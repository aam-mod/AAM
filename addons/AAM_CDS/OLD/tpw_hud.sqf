...
tpw_hud_fnc_goggles =
	...
	if (((goggles _unit) in ["G_Tactical_Black", "G_Tactical_Clear","G_Goggles_VR"]) || ((headgear _unit) in ["H_HelmetSpecO_blk","H_HelmetSpecO_ocamo","H_HelmetLeaderO_oucamo","H_HelmetLeaderO_ocamo"])) then
		{
